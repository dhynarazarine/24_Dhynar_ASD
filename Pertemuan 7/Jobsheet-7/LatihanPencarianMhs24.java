public class LatihanPencarianMhs24 {
    LatihanMahasiswa24 listMhs[];
    int idx;

    public LatihanPencarianMhs24(int maxSize) {
        listMhs = new LatihanMahasiswa24[maxSize];
    }
    void tambah(LatihanMahasiswa24 m) {

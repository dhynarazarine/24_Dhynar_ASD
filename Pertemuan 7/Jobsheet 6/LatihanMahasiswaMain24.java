...
public class LatihanMahasiswaMain24 {
    public static void main(String[] args) {
        ...
        LatihanPencarianMhs24 data = new LatihanPencarianMhs24(maxSize);
        ...
        for (int i = 0; i < maxSize; i++) {
            ...
            LatihanMahasiswa24 m = new LatihanMahasiswa24(nim, nama, umur, ipk);
            data.tambah(m);
        }
        System.out.println("---------------------------------------");
